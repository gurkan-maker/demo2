...
VALVE_DATABASE = [
    ...
    # Valve 8
    Valve(8, 600,
          {10:10, 20:20, 30:40, 40:151.9, 50:250, 60:483, 70:750, 80:992.4, 90:10950, 100:1172.1},
          0.99,
          {10:0.80, 20:0.80, 30:0.80, 40:0.80, 50:0.80, 60:0.80, 70:0.80, 80:0.80, 90:0.80, 100:0.80},
          1, 30, 4),      
...
VALVE_MODELS = {
    ...
    "8\" E34": "https://github.com/gurkan-maker/demo2/raw/refs/heads/main/obje-forged.glb",
...
def main():
    ...
    with tab_results:
        ...
        if st.session_state.show_3d_viewer:
            ...
            model_url = VALVE_MODELS.get(selected_valve_name, "https://github.com/gurkan-maker/demo2/raw/refs/heads/main/obje-forged.glb")
